...
-- Tiempo de generación: 18-01-2021 a las 20:35:04
...
--
CREATE DATABASE IF NOT EXISTS `videoaula` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `videoaula`;
...
CREATE TABLE IF NOT EXISTS `estados` (
  ...
  `limite` varchar(100) NOT NULL DEFAULT '0000-00-00 00:00:00',
...
(90, 138, 154, 'hola', 1610961726, 0),
(91, 154, 138, 'jajajajaj', 1610961741, 0),
(92, 138, 154, ':)', 1610961753, 0),
(93, 138, 154, ':)', 1610961756, 0),
(94, 138, 154, '8)', 1610961759, 0);
...
(3, 'maria.jpg', 'Maria da Silva', 'martinez', 'mariasilva@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Mujer', 'Colombia', '313608918', 9, 'diciembre', 2002, '2021-01-18 08:58:36', '2021-01-18 09:04:12', ''),
...
(138, 'keyner.jpg', 'Keyner ', 'peña herrera', 'keyner@hotmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Hombre', 'Colombia', '313608918', 9, 'diciembre', 2002, '2021-01-18 09:21:12', '2021-01-18 10:08:32', '2'),
...
(154, '', 'dfsf', 'dfds', 'jose@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Mujer', 'Australia', '1234566666', 5, 'agosto', 2004, '2021-01-18 09:54:42', '2021-01-18 10:51:15', '2');
COMMIT;
