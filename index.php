...
<div id="nav" style="display:block; width:1349px;    background: #08589a;
  ...
  <tr>
    <th scope="col"><span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;font-size:20px;color:#428bca;    text-shadow: 1px 0px 0px #000;"><i>Social Worki te ayuda a comunicarte y compartir con las personas que forman parte de tu vida.</i></span></th>
  </tr>
  <tr>
    <td><img src="material/image.png" width="537" height="195" /></td>
  </tr>
  <tr>
  <td><span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;font-size:20px;color:#428bca;    text-shadow: 1px 0px 0px #000;"><i>Bienvenidos A Worki Netword.</i></span></td>
  </tr>
</table>
</div>
<?php }else{ ?>
<div id="capaa" style="margin-right: 770px;margin-top:50px;margin-left:150px;">
  ...
  <tr>
  <td><span style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;font-size:20px;color:#428bca;    text-shadow: 1px 0px 0px #000;"><i>Social worki Te Espera Pronto.</i></span></td>
  </tr>
</table>
</div>
<?php } ?>
